...
echo -e "\n\n"
echo -e "  ┏━━━━━━━━━━━━━━━━━━━━━━┓"
echo -e "  ┃ ${c1}L${c2}i${c7}n${c4}s${c5}o${c6}${c7}f${c1}c${c0}      ${c5}𖦹${c0}  ${c6}𖦹${c0}  ${c7}𖦹${c0} ┃  ${codename}${c5}@${c0}${client_base}"
echo -e "  ┣━━━━━━━━━━━━━━━━━━━━━━┫"
...
echo -e "${c1}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${RESET}"
echo -e "${c1}┃${RESET}   ${c2}✔ Node.js Berhasil Diinstall${RESET}                     ${c1}┃${RESET}"
echo -e "${c1}┃${RESET}   ${c7}⚡ Startup Environment Ready${RESET}                      ${c1}┃${RESET}"
echo -e "${c1}┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫${RESET}"
echo -e "${c1}┃${RESET}   ${c6}👑 Created By${RESET} : ${c3}Lins Official${RESET}                     ${c1}┃${RESET}"
echo -e "${c1}┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫${RESET}"
echo -e "${c1}┃${RESET}   ${c5}📺 YouTube${RESET}   : https://youtube.com/@LinsOfficiall ${c1}┃${RESET}"
echo -e "${c1}┃${RESET}   ${c2}💬 WhatsApp${RESET}  : https://wa.me/6285190090045        ${c1}┃${RESET}"
echo -e "${c1}┃${RESET}   ${c4}📢 Channel Code${RESET}   : 0029VaeQHirJ93waiykxjF2L      ${c1}┃${RESET}"
echo -e "${c1}┃${RESET}   ${c6}🌐 Website${RESET}   : https://linsofc-store.vercel.app   ${c1}┃${RESET}"
echo -e "${c1}┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫${RESET}"
echo -e "${c1}┃${RESET}   ${c5}⚠ PERINGATAN${RESET}                                     ${c1}┃${RESET}"
echo -e "${c1}┃${RESET}   ${c3}Hati-hati akun palsu.${RESET}                            ${c1}┃${RESET}"
echo -e "${c1}┃${RESET}   ${c3}Gunakan kontak resmi di atas${RESET}${c1}                     ┃${RESET}"
echo -e "${c1}┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫${RESET}"
echo -e "${c1}┃${RESET}   ${c7}🚀 Linsofc${c1}♡${c7}Linux${RESET} | © 2025                         ${c1}┃${RESET}"
echo -e "${c1}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${RESET}"
echo -e "\n"
echo -e "${c4}┃${RESET} ${c2}Sedang menjalankan aplikasi Node.js...${RESET}\n"
