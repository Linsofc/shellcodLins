...
echo -e "${c1}┃${RESET}   ${c2}💬 WhatsApp${RESET}  : +6285190090045                    ${c1}┃${RESET}"
echo -e "${c1}┃${RESET}   ${c4}📢 Channel${RESET}   : whatsapp.com/channel/0029VaeQH…   ${c1}┃${RESET}"
echo -e "${c1}┃${RESET}   ${c6}🌐 Website${RESET}   : https://linsofc.github.io         ${c1}┃${RESET}"
echo -e "${c1}┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫${RESET}"
